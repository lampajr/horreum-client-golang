...
// ByIdId gets an item from the github.com/hyperfoil/horreum/pkg/raw_client.api.schema.item collection
...
// ByIdIdInteger gets an item from the github.com/hyperfoil/horreum/pkg/raw_client.api.schema.item collection
// returns a *SchemaIdItemRequestBuilder when successful
...
func (m *SchemaRequestBuilder) Get(ctx context.Context, requestConfiguration *SchemaRequestBuilderGetRequestConfiguration)(i474b066f9576d008d7de8ccd52cbe2ceff5e0826fad92c1bbc3202f77dfa272b.SchemaQueryResultable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i474b066f9576d008d7de8ccd52cbe2ceff5e0826fad92c1bbc3202f77dfa272b.CreateSchemaQueryResultFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i474b066f9576d008d7de8ccd52cbe2ceff5e0826fad92c1bbc3202f77dfa272b.SchemaQueryResultable), nil
}
...
func (m *SchemaRequestBuilder) Post(ctx context.Context, body i474b066f9576d008d7de8ccd52cbe2ceff5e0826fad92c1bbc3202f77dfa272b.Schemaable, requestConfiguration *SchemaRequestBuilderPostRequestConfiguration)(*int32, error) {
