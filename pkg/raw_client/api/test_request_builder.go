...
// ById gets an item from the github.com/hyperfoil/horreum/pkg/raw_client.api.test.item collection
...
// ByIdInteger gets an item from the github.com/hyperfoil/horreum/pkg/raw_client.api.test.item collection
// returns a *TestTestItemRequestBuilder when successful
...
func (m *TestRequestBuilder) Get(ctx context.Context, requestConfiguration *TestRequestBuilderGetRequestConfiguration)(i474b066f9576d008d7de8ccd52cbe2ceff5e0826fad92c1bbc3202f77dfa272b.TestQueryResultable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i474b066f9576d008d7de8ccd52cbe2ceff5e0826fad92c1bbc3202f77dfa272b.CreateTestQueryResultFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i474b066f9576d008d7de8ccd52cbe2ceff5e0826fad92c1bbc3202f77dfa272b.TestQueryResultable), nil
}
...
func (m *TestRequestBuilder) Post(ctx context.Context, body i474b066f9576d008d7de8ccd52cbe2ceff5e0826fad92c1bbc3202f77dfa272b.Testable, requestConfiguration *TestRequestBuilderPostRequestConfiguration)(i474b066f9576d008d7de8ccd52cbe2ceff5e0826fad92c1bbc3202f77dfa272b.Testable, error) {
